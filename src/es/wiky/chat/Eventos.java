	...
	public void onChat(AsyncPlayerChatEvent event){
		Player p = event.getPlayer();
				...
				String form1 = Mensajes.playerDisplayName(p.getName()) + org.bukkit.ChatColor.RESET + " " + event.getMessage();
		 		String form2 = ChatColor.translateAlternateColorCodes('&', Mensajes.playerDisplayName(Main.config.getString("Users." + p.getName() + ".cnick")) + org.bukkit.ChatColor.RESET + " " + event.getMessage());
